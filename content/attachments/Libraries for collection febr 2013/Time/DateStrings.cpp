...
char monthStr1[] PROGMEM = "Januari";
char monthStr2[] PROGMEM = "Februari";
char monthStr3[] PROGMEM = "Maart";
char monthStr4[] PROGMEM = "April";
char monthStr5[] PROGMEM = "Mei";
char monthStr6[] PROGMEM = "Juni";
char monthStr7[] PROGMEM = "Juli";
char monthStr8[] PROGMEM = "Augustus";
char monthStr9[] PROGMEM = "September";
char monthStr10[] PROGMEM = "October";
char monthStr11[] PROGMEM = "November";
char monthStr12[] PROGMEM = "December";
...
char monthShortNames_P[] PROGMEM = "ErrJanFebMrtAprMeiJunJulAugSepOctNovDec";
...
char dayStr0[] PROGMEM = "Err";
char dayStr1[] PROGMEM = "Zondag";
char dayStr2[] PROGMEM = "Maandag";
char dayStr3[] PROGMEM = "Dinsdag";
char dayStr4[] PROGMEM = "Woensdag";
char dayStr5[] PROGMEM = "Donderdag";
char dayStr6[] PROGMEM = "Vrijdag";
char dayStr7[] PROGMEM = "Zaterdag";

PGM_P dayNames_P[] PROGMEM = { dayStr0,dayStr1,dayStr2,dayStr3,dayStr4,dayStr5,dayStr6,dayStr7};
// char dayShortNames_P[] PROGMEM = "ErrSunMonTueWedThrFriSat";
char dayShortNames_P[] PROGMEM = "ErrZonMaaDinWoeDonVryZat";
