...
The TheThingsNetwork v2 stack is deprecated and the nodes and gateway have to be upgraded to the V3 stack. I have a DIY gateway running with an IMST IC880A-SPI LoRa board [[lorawan-gateway-diy]]
